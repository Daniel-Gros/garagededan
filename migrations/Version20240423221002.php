 ...
 */
final class Version20240423221002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ADD brand_id INT NOT NULL, ADD energies_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car DROP brand_id, DROP energies_id');
    }
}
